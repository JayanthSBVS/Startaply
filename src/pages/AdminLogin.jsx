  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-slate-900 py-10 px-6 shadow-2xl sm:rounded-[2rem] sm:px-10 border border-slate-800">
          <form className="space-y-6" onSubmit={handleLogin}>
            {error && (
              <div className="bg-red-900/30 text-red-400 text-sm p-4 rounded-2xl border border-red-900/50 font-medium">
                {error}
              </div>
            )}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-14 sm:text-sm bg-slate-950 border-slate-800 border focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 rounded-full py-4 pr-5 outline-none text-white transition-all font-medium"
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full flex justify-center py-4 px-4 border border-transparent rounded-full shadow-lg shadow-emerald-900/20 text-sm font-bold text-white bg-emerald-600 hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-900 focus:ring-emerald-500 disabled:bg-slate-700 disabled:text-slate-500 transition-all gap-2 items-center"
              >
