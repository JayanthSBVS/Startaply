  ...
  return (
    <div className="relative bg-emerald-950 py-12 border-b border-emerald-900 overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 max-w-5xl mx-auto grid grid-cols-2 md:flex md:flex-row justify-between items-center divide-y md:divide-y-0 md:divide-x divide-emerald-800/80 bg-emerald-900/40 backdrop-blur-md rounded-[2rem] border border-emerald-800/50 shadow-2xl overflow-hidden"
      >
        {stats.map((s, idx) => (
