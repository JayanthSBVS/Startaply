...
const EmptyState = ({ 
  ...
  return (
    <motion.div 
      ...
      className="flex flex-col items-center justify-center py-24 px-6 text-center bg-white rounded-[3rem] border border-slate-100 shadow-sm"
    >
      ...
      {onReset && (
        <button 
          onClick={onReset}
          className="group inline-flex items-center gap-3 bg-slate-950 hover:bg-emerald-600 text-white font-black py-4 px-10 rounded-2xl transition-all shadow-xl shadow-slate-950/20 hover:shadow-emerald-600/30 active:scale-95"
        >
